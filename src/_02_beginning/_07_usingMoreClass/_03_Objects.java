package _02_beginning._07_usingMoreClass;
...
public class _03_Objects {
	public static void main(String[] args) {
		Student s1 = new Student("RhieBro", 1);
		Student s2 = new Student("MinSeo", 2);
...
//	equals : Object.equals 와 같음, 객체타입이 오버라이딩했다면 equals의 결과, 두 객체 모두 null일때 true를 반환함
...
//	hash : 파라미터를 가지고 해쉬코드를 생성함, 내부적으로 Arrays.hashCode 사용(Object.hashCode()사용)
		...
		System.out.println(code1+", "+s2.hashCode());	//1510352같은 해쉬코드 출력
...
/*	requireNonNull
 * 	1) 객체 null 일때 NullPointerException 예외발생시킴
 ...
 * 	null이 아니면 객체 반환 */
		...
		try {
			...
			String str2 = Objects.requireNonNull(str1, ()->"???");
			//람다식(1.8) : Supplier 인터페이스 익명구현(익명구현이 뭔지, 왜하는지 다시한번 익힐것!)
		}catch(NullPointerException e) {
			System.out.println(e.getMessage());
		}
		
//	toString : 객체 정보 출력, 두번째는 객체가 null일 경우 출력될 메세지
		System.out.println(Objects.toString(null, "아무것도 없음!"));
	}
}
