...
public class _02_JavaCafeF {
	...
	public static void managerSystem(Scanner keyboard, String[] coffees, int[] stocks, int pw, int total) {
		...
		if(checkManagerPassword(inputPw, pw)) {
			viewCoffeesAndStocksAndTotal(coffees, stocks, total);//checkManagerPassword() 성공
		}else {
	...
	///////////////////Main Program///////////////////
	public static void javaCafe() {
		String[] coffees = {"아메리카노", "카페라떼", "에스프레소"}; //커피메뉴
